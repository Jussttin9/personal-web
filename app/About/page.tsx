            ...
            <div className={styles.container}>
                ...
                <div className={styles.about}>
                    <p>
                        ...
                        I&apos;ve been using my free time to learn a lot more about web development. In that time, I&apos;ve been able to create useful applications that assist users organize their thoughts and even spread awareness to current issues like climate change. I enjoy combining both of my interests by trying to implement appealing or fun elements to my websites such as a short game or activity or simply by adding a more aesthetic, more interactive look to the website. <br/><br/>
                        
                        Although, I do enjoy doing other things such as swimming, drawing, playing games &#40;i.e. Stardew Valley, Honkai Star Rail, and CyberPunk&#41;. I also really like listening to K-Pop and watching anime. <br/><br/>
